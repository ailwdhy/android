...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    // opciones para los spinners en arrays
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        // si el item seleccionado es del primer spinner
        if (adapterView.getId() == R.id.spinner1) {
            // dependiendo de la opción seleccionada, cambiamos el adaptador del segundo spinner
            if (i == 1) {
            ...
            // mostramos la opción seleccionada en el textview de la opción 1
            textito1.setText((String) adapterView.getItemAtPosition(i));
        } else if (adapterView.getId() == R.id.spinner2) {
            // mostramos la opción seleccionada en el textview de la opción 2
